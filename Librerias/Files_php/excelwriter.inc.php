		...
		xmlns:html="http://www.w3.org/TR/REC-html40">
                ...
                <!--[if gte mso 9]><xml>
                 <o:DocumentProperties>
                  <o:LastAuthor>Hoja1</o:LastAuthor>
                  <o:LastSaved>2017-11-02T07:46:23Z</o:LastSaved>
...
EOH;
        ...
        * @Return : Void
        */
        public function writeCol($value,$cols)
        {
	if($cols>0){ $cols = "colspan=".$cols;}else{$cols="";}
            if($this->state!="OPENED")
            {
                $this->error="Error : Please open the file.";
                return false;
            }    
            fwrite($this->fp,"<td class=xl24 width=64 $cols>$value</td>");
        }
    }
?> 