...
//----------------------------------------------------------------------------------------------------
	...
	this.border = "1px";	// border (CSS spec: size style color, e.g. "1px solid #D00000")
	this.padding = 4;					// padding (pixels)
	this.opacity = 95;					// opacity (1 - 100); not supported by all browsers
	this.cursorDistance = 30;			// distance from mouse cursor (pixels)
	this.xPos = "right";				// horizontal position: "left" or "right"
	this.yPos = "bootom";				// vertical position: "top" or "bottom"
	this.classN = "ToolTip";
